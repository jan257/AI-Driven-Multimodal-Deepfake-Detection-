...
# ✅ Dataset Class (same structure as frame model)
...
def main():
    ...
    model.classifier[1] = nn.Linear(num_ftrs, 2)  # 2 classes: fake (1), real (0)
    ...
    print("✅ Gaze Model saved to models/gaze_model.pth")
